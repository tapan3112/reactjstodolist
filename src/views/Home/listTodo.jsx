        ...
        <Row>
          {
            ...
            data.map(singleData =>
              (
                <Col sm="3" className='home-list-todo-col' key={singleData.id}>
                  <Card body style={{ borderColor: singleData.status ? '#2bf808' : '#E0E0E0' }}>
                    ...
                    <div className="text-center">
                      ...
                      {!singleData.status && <Button className="home-list-todo-button" size="sm" onClick={() => this.handleComplete(singleData.id)}>Complete</Button>}
                    </div>
                  </Card>
                </Col>
              )
